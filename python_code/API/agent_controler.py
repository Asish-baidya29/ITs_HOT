...
class AgentController():
    def __init__(self):
        ...
        self.recommendation_agent = RecommendationAgent('../API/recomendation_objects/apriori_recommendation.json',
                                                        '../API/recomendation_objects/popularity_recommendation.csv'
                                                        )
